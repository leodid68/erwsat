              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-primary">Recommandé • 2193 questions</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <Card className="glass-cosmic overflow-hidden">
          <div className="bg-gradient-to-br from-amber-400/20 to-amber-500/20 p-8 text-center">
            <div className="w-20 h-20 mx-auto rounded-3xl bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center shadow-lg mb-4">
