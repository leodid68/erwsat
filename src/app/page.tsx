...
export default function Home() {
  ...
  return (
    <div className="space-y-10 relative">
      ...
      <div className="fixed right-0 top-40 w-80 h-80 orb orb-pink opacity-60 -z-10" />
      <div className="fixed left-1/3 bottom-20 w-72 h-72 orb orb-violet opacity-50 -z-10" />
      ...
      <div className="relative">
        ...
        <div className="absolute right-0 top-0 w-32 h-32 orb orb-pink opacity-50" />
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href="/upload" className="block">
            <div className="liquid-glass-blue h-full cursor-pointer p-5">
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center mb-3 shadow-lg shadow-cyan-500/25">
          ...
          <Link href="/upload?tab=library" className="block">
            <div className="liquid-glass h-full cursor-pointer p-5" style={{ background: 'linear-gradient(135deg, rgba(139, 92, 246, 0.1), rgba(168, 85, 247, 0.05))' }}>
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-400 to-purple-500 flex items-center justify-center mb-3 shadow-lg shadow-violet-500/25">
          ...
          <Link href="/generate" className="block">
            <div className="liquid-glass-amber h-full cursor-pointer p-5">
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-400 to-amber-500 flex items-center justify-center mb-3 shadow-lg shadow-orange-500/25">
        ...
        <Link href="/progress" className="block">
          <div className="liquid-glass cursor-pointer p-5 flex items-center justify-between">
            <div className="flex items-center gap-4 relative z-10">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-400 to-violet-500 flex items-center justify-center shadow-lg shadow-indigo-500/25">
      ...
      {!hasProgress && quizzes.length === 0 && (
        <Card className="relative overflow-hidden border-dashed border-primary/30">
          ...
          <div className="absolute -left-10 -top-10 w-32 h-32 orb orb-pink opacity-30" />

          <CardContent className="py-16 text-center relative">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-primary via-violet-500 to-pink-500 flex items-center justify-center mx-auto mb-6 animate-float">
