...
export const AI_PROVIDERS: AIProviderConfig[] = [
  {
    ...
    models: [
      { id: 'claude-sonnet-4-5-20241022', name: 'Claude Sonnet 4.5', description: 'Recommandé - $3/$15 par M tokens' },
      { id: 'claude-sonnet-4-20250514', name: 'Claude Sonnet 4', description: 'Même prix - $3/$15 par M tokens' },
      { id: 'claude-opus-4-5-20251101', name: 'Claude Opus 4.5', description: 'Premium - $15/$75 par M tokens' },
      { id: 'claude-3-5-haiku-20241022', name: 'Claude 3.5 Haiku', description: 'Économique - $0.80/$4 par M tokens' },
    ],
    inputPrice: '$3',
    outputPrice: '$15',
  },
