    ...
    >
      ...
      <div
        className={cn(
          ...
          status === 'selected' && [
            'bg-gradient-to-br from-blue-700 to-blue-900 border-blue-700/50 text-white',
            'shadow-[0_0_20px_rgba(30,58,95,0.4)]',
          ],
      ...
      {status === 'selected' && (
        <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-700 via-blue-800 to-blue-700 animate-pulse" />
      )}
    </button>
  );
}
